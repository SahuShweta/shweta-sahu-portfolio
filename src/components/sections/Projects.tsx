...
const projects = [
  {
    title: "AI Personalized Course Pathway Agent",
    description:
      "Agentic AI web app that generates end-to-end personalized career roadmaps — skills, technologies, project ideas, certifications, and interview prep — using a multi-agent pipeline (Skill Analysis, Roadmap Recommendation, Project Recommendation) orchestrated through Streamlit.",
    tech: ["Python", "Streamlit", "IBM Granite", "LangFlow", "Agentic AI"],
    github: "https://github.com/SahuShweta/IBM-AICTE-Course-Agent",
    live: "https://github.com/SahuShweta/IBM-AICTE-Course-Agent",
    featured: true,
  },
  {
    title: "AI Resume Analyzer",
    description:
      "NLP-powered resume analysis tool that accepts PDF/DOCX uploads, compares content against a target job description, returns an ATS compatibility score (0–100%), categorizes matching vs. missing skills, and suggests AI-generated improvements. Deployed live on Hugging Face Spaces.",
    tech: ["Python", "NLP", "Streamlit", "Hugging Face"],
    github: "https://huggingface.co/spaces/Shweta103/AIResumeAnalyzer",
    live: "https://huggingface.co/spaces/Shweta103/AIResumeAnalyzer",
    featured: true,
  },
  {
    title: "AI Image Caption Generator",
    description:
      "Image-to-text captioning system using BLIP / ViT-GPT2 Vision-Language transformers from Hugging Face. Generates descriptive natural-language captions for any uploaded image. Deployed live on Hugging Face Spaces.",
    tech: ["Python", "Computer Vision", "Transformers", "Hugging Face"],
    github: "https://huggingface.co/spaces/Shweta103/aiImageCaptionGenerator",
    live: "https://huggingface.co/spaces/Shweta103/aiImageCaptionGenerator",
    featured: false,
  },
  {
    title: "Personal Portfolio Website",
    description:
      "Fully responsive portfolio built with reusable React components, clean UI, mobile-first layout, and continuous deployment via Vercel.",
    tech: ["TypeScript", "React.js", "Vercel"],
    github: "https://github.com/SahuShweta/shweta-sahu-portfolio",
    live: "https://shweta-sahu-portfolio-ecni.vercel.app",
    featured: false,
  },
];
